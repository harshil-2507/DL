#!/bin/bash
#SBATCH --job-name=d2           # 🔁 CHANGE
#SBATCH --partition=gpu
#SBATCH --output=/home/rahuldixit/aksh/dl_project/logs/o2_code2_%j.log  # 🔁 CHANGE
#SBATCH --error=/home/rahuldixit/aksh/dl_project/logs/e2_code2_%j.log    # 🔁 CHANGE
...
# ─────────────────────────────────────────────
# CUDA lib path — search both conda env AND
# ~/.local (pip sometimes installs nvidia libs there)
# ─────────────────────────────────────────────
...
# 🔹 Run your script
# ─────────────────────────────────────────────
SCRIPT_PATH=/home/rahuldixit/aksh/dl_project/code2.py

# Create output directories just in case
mkdir -p /home/rahuldixit/aksh/dl_project/logs
mkdir -p /home/rahuldixit/aksh/dl_project/outputs_code2
mkdir -p /home/rahuldixit/aksh/dl_project/saved_models_code2

echo "=========================================="
echo " STARTING WCE_Major_code2"
echo "=========================================="
