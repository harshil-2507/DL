#!/bin/bash
#SBATCH --job-name=d6         # 🔁 CHANGE
#SBATCH --partition=gpu
#SBATCH --output=/home/rahuldixit/aksh/dl_project/logs/o6_code6_%j.log  # 🔁 CHANGE
#SBATCH --error=/home/rahuldixit/aksh/dl_project/logs/e6_code6_%j.log    # 🔁 CHANGE
#SBATCH --gres=shard:20                      # 🔁 CHANGE ( no of charades if needed GPUs)
#SBATCH --cpus-per-task=16                   # 🔁 CHANGE plus per task. I number 
#SBATCH --mem=64G                            # 🔁 CHANGE if needed 
#SBATCH --time=0                      # 🔁 CHANGE (HH:MM:SS)
...
# 🔹 Run your script
# ─────────────────────────────────────────────
SCRIPT_PATH=/home/rahuldixit/aksh/dl_project/6_wce_major_final.py

# Create output directories just in case
mkdir -p /home/rahuldixit/aksh/dl_project/logs
mkdir -p /home/rahuldixit/aksh/dl_project/outputs_code6
mkdir -p /home/rahuldixit/aksh/dl_project/saved_models_code6

echo "=========================================="
echo " STARTING WCE_code6_final"
echo "=========================================="
