#!/bin/bash
#SBATCH --job-name=d5         # 🔁 CHANGE
#SBATCH --partition=gpu
#SBATCH --output=/home/rahuldixit/aksh/dl_project/logs/o5_code5_%j.log  # 🔁 CHANGE
#SBATCH --error=/home/rahuldixit/aksh/dl_project/logs/e5_code5_%j.log    # 🔁 CHANGE
...
# 🔹 Run your script
# ─────────────────────────────────────────────
SCRIPT_PATH=/home/rahuldixit/aksh/dl_project/5_wce_major_final.py

# Create output directories just in case
mkdir -p /home/rahuldixit/aksh/dl_project/logs
mkdir -p /home/rahuldixit/aksh/dl_project/outputs_code3
mkdir -p /home/rahuldixit/aksh/dl_project/saved_models_code3
